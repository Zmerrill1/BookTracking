...
status_enum = ENUM('READING', 'COMPLETED', 'TO_READ', name='statusenum', create_type=False)
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_userbookstatus_book_id'), 'userbookstatus', ['book_id'], unique=False)
    op.create_index(op.f('ix_userbookstatus_status'), 'userbookstatus', ['status'], unique=False)
    op.create_index(op.f('ix_userbookstatus_user_id'), 'userbookstatus', ['user_id'], unique=False)
